...
$health=$_POST['blood'];
$aeid=$_POST["ID"];
$sql = "UPDATE tblappointment SET blood_group=:health WHERE  ID=:aeid";
$query = $dbh->prepare($sql);
...
<?php $sql = "SELECT * from  tblappointment WHERE health_status IS NOT NULL AND blood_group IS NULL ";
$query = $dbh -> prepare($sql);
$query->execute();
